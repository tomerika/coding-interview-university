...
* He made it to amazon after 11 months dedicated to study
* Google, Amazon, Facebook and Microsoft view software engineering as different from software/web development, and they require computer science knowledge.
* you should tackle the items in order from top to bottom.
## Table of Contents
